...
import ClubeLibertadores from './components/ClubeLibertadores.vue'
import ClubeRebaixados from './components/ClubeRebaixados.vue'
import $ from 'jquery'
...
Vue.component('clubes-libertadores', ClubeLibertadores)
Vue.component('clubes-rebaixados', ClubeRebaixados)
new Vue({
    //  hyperScript -> Renderizar o HTML
    render: h => h(App),
    provide() {
        return {
            timesColecao: [
